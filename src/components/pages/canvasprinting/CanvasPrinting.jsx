        ...
        <div className='row canvasprinting'>
            ...
            <div className='col-md-6 canvasprinting-right'>
                ...
                <div className='sizebox'>
                    <div className='size-top'><span style={{fontWeight:"500"}}>SIZE</span> <span  style={{fontWeight:"500"}}>SIDE</span></div>
                    <div className='size-buttom'><select style={{with:"62%"}}>
                     <option>A4</option> <option>A3</option><option>Legal</option></select> <input type='radio'/>One sided</div>
                </div>
                <div className='reimg-button-container' style={{marginTop:"100px"}}>
