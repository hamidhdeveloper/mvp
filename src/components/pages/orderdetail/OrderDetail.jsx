        ...
        <div className='row order-bottom' >
               <div className='col-md-6 order-bottom-left'>
                 <table className='table1'>
                  ...
                  <tr>
                    <td><input type='number' /></td> <td><select><option>1</option><option>2</option><option>3</option></select></td>
                  </tr>
                  <tr>
                    <td></td> <td><input type='checkbox' />Custom</td>
                  </tr>

                 </table>
                 <table className='table2'>
                      <tr>
                        <td></td> <td>Urgency</td><td>Price</td> <td>Production in Riyadh Factory<br/> (Delivery time not included)</td>
                      </tr>
                      <tr>
                        <td><input type='radio' /></td> <td>Regular</td><td>72.66</td> <td>3 working day(s) </td>
                      </tr>
                 </table>
